...
const UserProfile = () => {
  ...
  const profileFields = [
    { label: 'First Name', type: 'text', id: 'firstName', value: 'Bhau' },
    { label: 'Last Name', type: 'text', id: 'lastName', value: 'Kadam' },
    { label: 'Email', type: 'email', id: 'email', value: 'example@example.com' },
    { label: 'Age', type: 'number', id: 'age', value: '25' },
    { label: 'Gender', type: 'select', id: 'gender', value: 'male', options: ['Male', 'Female', 'Other'] },
    { label: 'Address', type: 'text', id: 'address', value: '123 Main St, Cityville' },
    { label: 'State', type: 'select', id: 'state', value: '', options: ['Select State', 'Andhra Pradesh', 'Karnataka', 'Maharashtra'] },
    { label: 'Country', type: 'text', id: 'country', value: 'India', readOnly: true },
    { label: 'Pin Code', type: 'text', id: 'pincode', value: '123456' },
  ];
