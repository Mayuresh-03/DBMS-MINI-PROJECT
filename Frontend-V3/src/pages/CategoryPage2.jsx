...
const CategoryPage3 = () => {
            ...
            if (response.headers['content-type'].includes('application/json')) {
                if (Array.isArray(response.data)) {
                    const filteredProducts = response.data.filter(product => {
                        ...
                        return productPrice <= maxPriceProp;
                    });
                    ...
                    if (prices.length > 0) {
                        ...
                        const maxPriceData = maxPriceProp !== null ? maxPriceProp : maxPrice;
                        setMinMaxPrice([minPrice, maxPriceData]);
                        setPriceRange([minPrice, maxPriceData]);
                    } else {
    ...
    useEffect(() => {
        fetchData(true, maxPrice ? parseInt(maxPrice) : null);
    }, [category, maxPrice]);
