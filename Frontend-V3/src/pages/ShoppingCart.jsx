...
const ShoppingCart = () => {
  ...
  const totalCost = cartItems.reduce((acc, item) =>
    acc + (parseFloat(item.cost) * parseInt(item.quantity, 10)), 0) + shippingCost;

  return (
    <div className="bg-gradient-to-r from-indigo-100 to-purple-100 min-h-screen mt-10">
      <div className="container mx-auto mt-10 px-4">
        <div className="lg:flex lg:space-x-12">
          <div className="lg:w-2/3 bg-white shadow-xl rounded-lg p-8 h-full mt-10">
          ...
          <div className="lg:w-1/3 bg-white shadow-xl rounded-lg p-8  lg:mt-10 ">
