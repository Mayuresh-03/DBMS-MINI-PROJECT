        ...
        <div>
            ...
            <form id="profileForm" className="space-y-4" onSubmit={handleSubmit}>
                <div>
                    ...
                    <input type="text" id="name" name="username" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm py-3 px-4" value={profileData.username} onChange={handleChange} />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="country" name="country" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm py-3 px-4" value={profileData.country} onChange={handleChange} />
                </div>
                <div>
                    <label htmlFor="pincode" className="block text-sm font-medium text-gray-700">Pin Code</label>
                    <input type="text" id="pincode" name="pincode" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm py-3 px-4" value={profileData.PIN} onChange={handleChange} />
                </div>
